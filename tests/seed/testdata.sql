...
INSERT INTO visits (id, patient_id, entry_type, status, machine_state, started_at, updated_at, ask_round, ask_round_limit, lab_round, lab_round_limit, summary) VALUES
('v001', 'p001', 'new', 'completed', 'completed', '2026-06-01 09:00:00', '2026-06-01 09:30:00', 3, 20, 1, 10, '{"chiefComplaint": "发热咳嗽", "diagnosis": "急性上呼吸道感染", "treatmentSummary": "布洛芬缓释胶囊"}'),
('v002', 'p002', 'new', 'chatting', 'chatting', '2026-06-15 14:00:00', '2026-06-15 14:05:00', 1, 20, 0, 10, '{"chiefComplaint": "头痛"}');
